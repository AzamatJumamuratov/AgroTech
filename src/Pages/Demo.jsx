...
const slides = [
    ...
    content: (
      <div className="flex flex-col justify-center h-full px-12 md:px-20">
        ...
        <p className="text-xl md:text-2xl text-white/50 font-light leading-relaxed">
          Awıl xojalıǵı kárxanasınıń jumısın jarıtıw ushın <br /> SI
          járdemindegi platforma
        </p>
  ...
  },
  {
    ...
    content: (
      <div className="px-12 md:px-20 py-10">
        <p className="font-serif text-7xl font-black text-amber-400/20 leading-none -mb-4">
          01
        </p>
        <h2 className="font-serif text-4xl md:text-5xl font-bold text-emerald-900 mb-8">
          Kirispe
        </h2>
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl p-8 shadow-md border-t-4 border-amber-400 hover:-translate-y-1 transition-transform">
            ...
            <h3 className="font-serif text-xl font-bold text-emerald-900 mb-4">
              Mashqala
            </h3>
            <ul className="space-y-3">
              {[
                ...
                "Kompaniya menen baylanıs ornatıwdıń múrákkepligi",
              ].map((t, i) => (
                <li
                  key={i}
                  className="text-gray-500 text-[0.95rem] leading-relaxed pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1.5 before:h-1.5 before:rounded-full before:bg-amber-400"
                >
                  {t}
                </li>
              ))}
          ...
          <div className="bg-white rounded-2xl p-8 shadow-md border-t-4 border-emerald-600 hover:-translate-y-1 transition-transform">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Chat-bot fermerlerge 24/7 másláhát beredi",
              ].map((t, i) => (
                <li
                  key={i}
                  className="text-gray-500 text-[0.95rem] leading-relaxed pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1.5 before:h-1.5 before:rounded-full before:bg-emerald-500"
                >
                  {t}
                </li>
              ))}
  ...
  },
  {
    ...
    content: (
      <div className="px-12 md:px-20 py-10">
        <p className="font-serif text-7xl font-black text-amber-400/30 leading-none -mb-4">
          02
        </p>
        ...
        <div className="bg-white/10 border border-white/20 text-white rounded-xl p-6 text-lg mb-8">
          AgroTech kompaniyası ushın AI integraciyalanǵan kóp tillik
          veb-platforma jaratıw
        </div>
          ...
          {[
            {
              n: "01",
              t: "AI chat-bot",
              d: "Aqıllı agronom hám kompaniya assistenti jaratıw",
            },
            {
              n: "02",
              t: "RAG izlew",
              d: "Semantikalıq izlew sistemasın pgvector arqalı qurıw",
            },
            {
              n: "03",
              t: "Avtomatlastırıw",
              d: "Múrájaatlardı AI arqalı avtomatlastırıw",
            },
          ].map((c) => (
            <div
              key={c.n}
              className="bg-white/10 rounded-2xl p-8 text-center hover:-translate-y-1 transition-transform"
            >
              <div className="font-serif text-4xl font-black text-amber-400 mb-2">
                {c.n}
              </div>
        ...
        <div className="grid grid-cols-2 gap-5">
          {[
            ...
            },
            {
              ...
              items: ["React 19 + Vite 6", "Tailwind CSS 4", "i18next (4 til)"],
            },
            {
              cat: "AI / ML",
              color: "bg-amber-500",
            ...
            >
              <div className={`${g.color} text-white px-5 py-3 font-bold`}>
                {g.cat}
              </div>
      ...
      <div className="px-12 md:px-20 py-10">
        ...
        <div className="flex flex-col items-center gap-0">
          {[
            {
              label: "Frontend",
              sub: "React 19 + Vite + Tailwind CSS + i18next",
              extra: "RU • EN • UZ • KK",
              color: "bg-emerald-500",
            },
            {
              label: "REST API",
              sub: "Django DRF + JWT Auth + Rate Limiting + CORS",
              color: "bg-emerald-700",
            },
            {
              label: "Database + AI",
              sub: "PostgreSQL + pgvector + Gemini API + Embeddings",
              color: "bg-emerald-900",
            },
          ].map((l, i) => (
            <div key={l.label}>
              {i > 0 && (
                <div className="text-center text-white/30 text-xl py-1">▼</div>
              )}
              <div
                className={`${l.color} text-white rounded-xl px-8 py-5 w-[700px] flex items-center gap-8`}
              >
                <span className="font-bold text-lg min-w-[120px]">
                  {l.label}
                </span>
  ...
  },
  {
    ...
    content: (
      <div className="px-12 md:px-20 py-10">
        ...
        <h2 className="font-serif text-4xl md:text-5xl font-bold text-emerald-900 mb-2">
          AI Chat-bot
        </h2>
        <p className="text-gray-500 mb-6">
          Aqıllı assistent — sayttan izlew, másláhát beriw, múrájaat jiberiw
        </p>
        <div className="grid grid-cols-2 gap-5">
          {[
            {
              icon: "🔍",
              t: "Sayttan izlew",
              d: "Jańalıqlar, joybarlar, kontaktlar boyınsha AI semantikalıq izlew",
            },
            {
              icon: "🌱",
              t: "Agronomiyalıq másláhát",
              d: "Region, topıraq, maqsetke baylanıslı egin usınısı",
            },
            {
              icon: "📨",
              t: "Múrájaat jiberiw",
              d: "AI ózi kompaniyaǵa kontakt sorawın avtomat jiberedi",
            },
            {
              icon: "📄",
              t: "PDF hújjetler",
              d: "Kontrakt hám shartnanalardı avtomat generaciyalaw",
            },
          ].map((f) => (
            <div
              key={f.t}
              className="bg-white rounded-2xl p-6 shadow-sm border-l-4 border-emerald-600 hover:-translate-y-1 transition-transform"
            >
  ...
  },
  {
    ...
    content: (
      <div className="px-12 md:px-20 py-10">
        ...
        <h2 className="font-serif text-4xl md:text-5xl font-bold text-white mb-8">
          RAG — Semantikalıq izlew
        </h2>
        <div className="space-y-3">
          {[
            {
              n: "1",
              t: "Kontent indeksaciya",
              d: "Jańalıqlar, joybarlar → Gemini Embedding → Vektor",
            },
            {
              n: "2",
              t: "pgvector saqlawlar",
              d: "Vektorlar PostgreSQL bazasında saqlanadı",
            },
            {
              n: "3",
              t: "Soraw embedding",
              d: "Paydalanıwshı sorawı → Gemini arqalı vektorǵa aylandırıladı",
            },
            {
              n: "4",
              t: "Kosinus izlew",
              d: "CosineDistance arqalı eń jaqın 5 dokument tabıladı",
            },
            {
              n: "5",
              t: "AI juwap",
              d: "Kontekst + soraw → Gemini 2.5 Flash → Tolıq juwap",
            },
          ].map((s) => (
            <div
              key={s.n}
              className="flex items-center gap-5 py-3 border-b border-white/10"
            >
        ...
        <div className="mt-6 bg-amber-400/15 rounded-lg px-5 py-3 text-amber-400 text-sm">
          ⚡ Kontent jańalanǵanda embeddingler avtomat jańalanadı (Django
          signals)
        </div>
      </div>
    ),
      ...
      <div className="px-12 md:px-20 py-10">
        ...
        <div className="flex items-stretch gap-4">
          <div className="flex-1 bg-emerald-50 rounded-2xl p-6 border-t-4 border-emerald-600">
            <h3 className="font-serif text-lg font-bold text-emerald-900 mb-4">
              Kiriwshi maǵlıwmatlar
            </h3>
            {[
              "🌍 Region (qala atı)",
              "🏔️ Topıraq túri",
              '🌱 Egin (yamasa "bilmeymen")',
              "🎯 Maqset: zúráát / payda / turaqłılıq",
            ].map((f, i) => (
              <div
                key={i}
                className="bg-white rounded-lg px-4 py-3 mb-2 text-sm"
              >
                {f}
              </div>
            ))}
          </div>
          <div className="flex items-center text-3xl text-amber-400 font-bold">
            →
          </div>
          <div className="flex-1 bg-emerald-50 rounded-2xl p-6 border-t-4 border-amber-400">
            ...
            <p className="italic text-emerald-700 text-sm mb-3">
              "Siziń regionıńız ushın usınıs..."
            </p>
            <ul className="space-y-2 text-sm text-gray-500 mb-4">
              <li className="pl-3 relative before:content-['•'] before:absolute before:left-0 before:text-amber-400">
                3-5 egin usınısı + sebebi
              </li>
              <li className="pl-3 relative before:content-['•'] before:absolute before:left-0 before:text-amber-400">
                Egiw hám jıynaw kalendarı
              </li>
              <li className="pl-3 relative before:content-['•'] before:absolute before:left-0 before:text-amber-400">
                Kútim boyınsha másláhát
              </li>
            </ul>
      ...
      <div className="px-12 md:px-20 py-10">
        ...
        <div className="flex gap-5 mb-8">
          {[
            ...
            <div
              key={s.n + s.l}
              className="flex-1 bg-white rounded-2xl p-6 text-center shadow-sm"
            >
              <div className={`font-serif text-5xl font-black ${s.c}`}>
                {s.n}
              </div>
        ...
        <div className="bg-emerald-50 rounded-xl p-6 space-y-3">
          {[
            ...
            <div key={i} className="flex items-center gap-3">
              <span className="w-7 h-7 rounded-full bg-emerald-600 text-white flex items-center justify-center text-xs shrink-0">
                ✓
              </span>
    ...
    content: (
      <div className="flex flex-col justify-center h-full px-12 md:px-20">
        ...
        <p className="text-lg text-white/50 leading-relaxed max-w-2xl mb-8">
          AgroTech platforması awıl xojalıǵı tarawında AI texnologiyalardı
          qollanıwdıń praktikalıq mısalı boldı.
        </p>
        <div className="space-y-3 mb-8">
          {[
            ...
            <div
              key={i}
              className="text-white/60 py-3 border-b border-white/10"
            >
              {p}
            </div>
          ))}
...
export default function Demo() {
  ...
  return (
    <div
      className={`relative w-screen h-screen overflow-hidden ${bgClass[slide.bg]} transition-colors duration-500`}
    >
      {/* Slide content */}
